...
model4 = lmer(MOT_MLU ~ VISIT + Diagnosis + (1+VISIT|ANO_SUBJ)+ (1|Gender)+ (1|Ethnicity), data = autism_data, REML = FALSE)
...
model5 = lmer(CHI_MLU ~ VISIT + Diagnosis + verbalIQ1 + (1+VISIT|ANO_SUBJ)+ (1|Gender)+ (1|Ethnicity), data = autism_data, REML = FALSE)

model6 = lmer(CHI_MLU ~ VISIT + Diagnosis + verbalIQ1 + nonverbalIQ1 + (1+VISIT|ANO_SUBJ)+ (1|Gender)+ (1|Ethnicity), data = autism_data, REML = FALSE)

model7 = lmer(CHI_MLU ~ VISIT + Diagnosis + ADOS1 + (1+VISIT|ANO_SUBJ)+ (1|Gender)+ (1|Ethnicity), data = autism_data, REML = FALSE)

model8 = lmer(CHI_MLU ~ VISIT + Diagnosis + ADOS1 + verbalIQ1 + nonverbalIQ1 + (1+VISIT|ANO_SUBJ)+ (1|Gender)+ (1|Ethnicity), data = autism_data, REML = FALSE)

model9 = lmer(CHI_MLU ~ VISIT + Diagnosis  + ADOS1 + verbalIQ1 + nonverbalIQ1 + I(VISIT^2)+(1+VISIT+ I(VISIT^2)|ANO_SUBJ)+ (1|Gender)+ (1|Ethnicity), data = autism_data, REML = FALSE)
